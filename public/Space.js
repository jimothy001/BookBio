...
function TimeMark() //TIME DEMARCATION
{
	...
	this.MapMarks(time.start, time.end);

	return this;
}

TimeMark.prototype.UpdateBounds = function()
{
	var start = 0;
	var end = time.end;
	...
	for(var i in collections)
	{
		...
		if(c.active)
		{
			for(var j in collections[i].editions)
			{
